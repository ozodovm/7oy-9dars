        ...
        <div className="p-5">
            ...
            >
                <Form form={form} onFinish={handleEditSubmit} layout="vertical">
                    ...
                    >
                        <Input className="border border-gray-300 rounded-md p-2 focus:ring-2 focus:ring-blue-500 transition-shadow duration-200" />
                    </Form.Item>
                    <Form.Item 
                        name="surname" 
                        label="Surname" 
                    ...
                    >
                        <Input type="number" className="border border-gray-300 rounded-md p-2 focus:ring-2 focus:ring-blue-500 transition-shadow duration-200" />
                    </Form.Item>
                    <Form.Item>
                        <button type="submit" className="bg-blue-500 text-white w-full rounded-md p-2 hover:bg-blue-600 transition duration-200 font-semibold">
                            Saqlash
                        </button>
                    </Form.Item>
                </Form>
